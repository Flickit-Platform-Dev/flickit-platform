                    ...
                    <Box>
                        ...
                        >
                            <Select
                                ...
                                renderValue={memberSelected == "" ? () => <Box sx={{
                                    color: "#6C7B8E", fontSize: "0.6rem", textAlign: "left",
                            ...
                            >
                                ...
                                {memberOfSpace && memberOfSpace.length > 0 && memberOfSpace.map((member: any, index: number) => (
                                    <MenuItem
                                        ...
                                        sx={{
                                            paddingY: "0px", maxHeight: "200px", gap: "20px",
                                    ...
                                    >
                                        <Box sx={{
                                            display: "flex", gap: { xs: "2px", sm: "10px" },
                                            justifyContent: "flex-start", alignItems: "center"
                                        }}>
                                            <Avatar
                                                sx={{
                                                    width: { xs: '1.3rem', sm: '2rem' }, height: { xs: '1.3rem', sm: '2rem' },
                                                    fontSize: { xs: '0.7rem', sm: '1rem' }
                                                }}
                    ...
                    <div>
                        ...
                        >
                            <Select
                                ...
                                IconComponent={KeyboardArrowDownIcon}
                                inputProps={{
                                    renderValue: () => (roleSelected?.title == "" ? <Box sx={{
                                        color: "#6C7B8E", fontSize: "0.6rem", textAlign: "left",
                                        overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'
